...
const Courses = () => {
  ...
  const renderSafeValue = (value, fallback = "Noma'lum") => {
    ...
    <div className="space-y-8 pb-10 px-2 md:px-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="space-y-1">
          <h1 className="text-4xl font-black uppercase tracking-tighter italic text-black">Kurslar</h1>
          <p className="text-slate-400 font-bold text-sm tracking-wide">Barcha mavjud yo'nalishlar boshqaruvi</p>
        </div>
