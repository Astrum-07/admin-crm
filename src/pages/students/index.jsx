          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-black text-white uppercase text-[11px] tracking-[2px] font-black">
                <th className="py-5 px-6">Talaba ma'lumoti</th>
                <th className="py-5 px-6 hidden md:table-cell">Telefon / Aloqa</th>
                <th className="py-5 px-6 text-center">Guruhlar</th>
                  ...
                  <tr key={student._id} className="hover:bg-slate-50 transition-colors group">
                    <td className="py-5 px-6">
                      <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 border-2 border-black bg-white flex items-center justify-center text-black font-black text-lg shadow-[3px_3px_0_0_rgba(0,0,0,1)] group-hover:bg-black group-hover:text-white transition-all">
